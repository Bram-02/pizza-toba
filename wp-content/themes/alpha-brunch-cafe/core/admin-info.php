 ...
 */
class Alpha_Brunch_Cafe_Admin_Info {
    /**
    ...
    public function add_menu() {
        add_theme_page(
            esc_html__('Alpha Brunch Cafe Theme', 'alpha-brunch-cafe'),
            esc_html__('Alpha Brunch Cafe Theme', 'alpha-brunch-cafe'),
            'edit_theme_options',
            'alpha-brunch-cafe',
    ...
    public function reset_notification_dismissal() {
        delete_transient('alpha_brunch_cafe_notification_dismissed');
    }
    ...
    public function compatible_check() {
        $dismissed = get_option('alpha_brunch_cafe_notification_dismissed');
        if (!$dismissed) {
    ...
    public function dismiss_notification() {
        update_option('alpha_brunch_cafe_notification_dismissed', true);
    }
            ...
            (function($) {
                $(document).on('click', '.notice.is-dismissible .notice-dismiss', function() {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'dismiss_alpha_brunch_cafe_notification',
...
new Alpha_Brunch_Cafe_Admin_Info();